// ---------------- search.js (FOR FRONTEND + RENDER BACKEND) ---------------- //
...
async function fetchBuses() {
    ...
    let url = `${BACKEND_URL}/api/buses?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`;
    ...
    try {
        ...
        resultsDiv.innerHTML = `<p style="color:red; text-align:center;">
            Error fetching buses. Please check your backend URL.
        </p>`;
    }
}
